...
public class ApplicationInMemory {
    ...
    private final RingBuffer<AdjustedResultEvent> adjustedResultRb = createSingleProducer(AdjustedResultEvent::new, RING_BUFFER_BUFFER_SIZE, new YieldingWaitStrategy());
    ...
    private final AdjustmentProcess adjustmentProcess = new AdjustmentProcess(primaryGreekRb, marketDataRb, adjustedResultRb);
    ...
    public static int getRingBufferBufferSize() {
        return RING_BUFFER_BUFFER_SIZE;
    }
    ...
    public RingBuffer<AdjustedResultEvent> getAdjustedResultRb() {
        return adjustedResultRb;
    }

    public PrimaryValuationProcess getPrimaryValuationProcess() {
        return primaryValuationProcess;
    }

    public SecondaryValuationProcess getSecondaryValuationProcess() {
        return SecondaryValuationProcess;
    }
