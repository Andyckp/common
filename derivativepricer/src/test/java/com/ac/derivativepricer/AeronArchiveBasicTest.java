...
public class AeronArchiveBasicTest {
    ...
    private final File tempDir = Util.createTempDir();
    ...
    @Test
    public void runFor10s() throws InterruptedException {
        final AeronArchiveBasicTest test = new AeronArchiveBasicTest();
        try {
            test.setup();
            LOGGER.info("Writing");
            new Thread(() -> {
